...
contextBridge.exposeInMainWorld("api", {
  ...
  getWatchFolder: () => ipcRenderer.invoke("watch:get"),
  pickWatchFolder: () => ipcRenderer.invoke("watch:pick"),
  setWatchFolder: (path) => ipcRenderer.invoke("watch:set", path),
  onWatchStatus: (handler) => ipcRenderer.on("watch:status", (_event, payload) => handler(payload)),
